...
import type { ModelServingSize } from '@odh-dashboard/internal/pages/modelServing/screens/types';
import { getInferenceServiceSize } from '@odh-dashboard/internal/pages/modelServing/utils';
