...
For an in-depth guide on how to deploy the MLflow UI, please refer to the [local kubernetes deployment](./docs/local-deployment-guide.md) documentation.

To quickly enable the MLflow UI in your Kind cluster, you can use the following command:
