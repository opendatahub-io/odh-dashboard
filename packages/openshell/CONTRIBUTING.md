...
For an in-depth guide on how to deploy the Openshell UI, please refer to the [local kubernetes deployment](./docs/local-deployment-guide.md) documentation.

To quickly enable the Openshell UI in your Kind cluster, you can use the following command:
