...
// MockClient implements plsvc.Client with configurable function fields.
...
func (m *MockClient) CreatePipelineRun(ctx context.Context, baseURL string, input *plsvc.CreatePipelineRunInput) (*plsvc.PipelineRun, error) {
...
func (m *MockClient) GetPipelineRun(ctx context.Context, baseURL string, runID string) (*plsvc.PipelineRun, error) {
...
func (m *MockClient) ListPipelineRuns(ctx context.Context, baseURL string, params *plsvc.ListRunsParams) (*plsvc.PipelineRunResponse, error) {
...
func (m *MockClient) TerminateRun(ctx context.Context, baseURL string, runID string) error {
...
func (m *MockClient) RetryRun(ctx context.Context, baseURL string, runID string) error {
...
func (m *MockClient) DeleteRun(ctx context.Context, baseURL string, runID string) error {
...
func (m *MockClient) ListPipelines(ctx context.Context, baseURL string, filter string) (*plsvc.PipelinesResponse, error) {
...
func (m *MockClient) GetPipelineVersion(ctx context.Context, baseURL string, pipelineID, versionID string) (*plsvc.PipelineVersion, error) {
...
func (m *MockClient) ListPipelineVersions(ctx context.Context, baseURL string, pipelineID string) (*plsvc.PipelineVersionsResponse, error) {
...
func (m *MockClient) CreatePipeline(ctx context.Context, baseURL string, name string) (*plsvc.Pipeline, error) {
...
func (m *MockClient) UploadPipelineVersion(ctx context.Context, baseURL string, pipelineID string, versionName string, fileContent []byte) (*plsvc.PipelineVersion, error) {
...
// Compile-time check.
var _ plsvc.Client = (*MockClient)(nil)
