...
describe('deleteFeatureStore', () => {
  ...
  it('should call k8sDeleteResource and normalize the result', async () => {
    const rawResponse = makeFeatureStore();
    k8sDeleteResourceMock.mockResolvedValue(rawResponse as never);
