    ...
    overrides: [
      {
        ...
        rules: {
          ...
          'no-restricted-syntax': [
            ...
            {
              selector:
                "ImportDeclaration[importKind!='type'][source.value=/^@odh-dashboard\\u002F(?!internal\\u002F__mocks__)(?!internal\\u002Fapi\\u002Fmodels)(?!internal\\u002Fapi\\u002Fk8s)(?!app-config)(?!k8s-core)(?!model-serving\\u002Fshared)(?!plugin-core\\u002Fareas)(?!.*\\u002Fmocks)(?!.*(types|Types|__mocks__|__tests__|getCorePipelineSpec|utils|storageEnums|useStopModalPreference|const)).*$/]",
              message:
