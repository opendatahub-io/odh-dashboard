...
class ModelMetricsPerformance extends ModelMetricsGlobal {
  visit(project: string, model: string) {
    cy.visitWithLogin(`/ai-hub/models/deployments/${project}/metrics/${model}/performance`);
    this.wait();
  }
...
class ModelMetricsBias extends ModelMetricsGlobal {
  visit(project: string, model: string, disableA11y = false) {
    cy.visitWithLogin(`/ai-hub/models/deployments/${project}/metrics/${model}/bias`);
...
class ModelMetricsConfigureSection {
  visit(project: string, model: string) {
    cy.visitWithLogin(`/ai-hub/models/deployments/${project}/metrics/${model}/configure`);
    this.wait();
  }
