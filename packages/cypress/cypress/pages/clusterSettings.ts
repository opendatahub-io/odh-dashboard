...
class GlobalProjectSettingsPage extends ClusterSettings {
  ...
  findSelectorToggle() {
    return cy.findByTestId('global-project-selector-toggle');
  }

  selectProject(name: string) {
    this.findSelectorToggle().click();
    cy.findByTestId('global-project-selector-menuList').contains(name).click();
  }

  selectNone() {
    this.findSelectorToggle().click();
    cy.findByTestId('global-project-selector-menuList').contains('None').click();
  }
}
