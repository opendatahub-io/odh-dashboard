...
class RegisterVersionPage {
  visit(registeredModelId?: string) {
    ...
    cy.visitWithLogin(
      registeredModelId
        ? `/ai-hub/models/registry/${preferredModelRegistry}/registered-models/${registeredModelId}/register/version`
        : `/ai-hub/models/registry/${preferredModelRegistry}/register/version`,
    );
    this.wait();
  }
