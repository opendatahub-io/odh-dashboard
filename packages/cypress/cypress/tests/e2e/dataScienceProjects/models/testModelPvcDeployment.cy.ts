...
describe('[Product Bug: RHOAIENG-41827][@Automation Bug: RHOAIENG-41299] Verify a model can be deployed from a PVC', () => {
  retryableBefore(() => {
  ...
  it(
    ...
    { tags: ['@Smoke', '@SmokeSet3', '@Dashboard', '@ModelServing', '@Bug', '@Maintain'] },
    () => {
