import { loadResourcesFixture } from '../../../utils/dataLoader';
...
import { checkResources } from '../../../utils/resourceCheckUtils';
...
describe('Create a custom resource Quickstart by using Dashboard CRDs', () => {
  ...
  retryableBefore(() =>
    loadResourcesFixture('e2e/learningResources/testCustomResourceCreation.yaml').then((data) => {
      resourcesData = data;
