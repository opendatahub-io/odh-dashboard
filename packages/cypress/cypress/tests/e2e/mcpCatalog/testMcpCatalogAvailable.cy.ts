...
describe('Verifies that MCP Catalog is available for different users', () => {
  it(
    'Verifies that MCP Catalog is available for an admin user',
  ...
  it(
    'Verifies that MCP Catalog is available for a regular user',
    { tags: ['@Dashboard', '@McpCatalog', '@Featureflagged'] },
    () => {
