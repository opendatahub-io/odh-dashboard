...
} from '@odh-dashboard/internal/__mocks__/index';
import { mockConfigMap } from '@odh-dashboard/internal/__mocks__/mockConfigMap';
import { mockDscStatus } from '@odh-dashboard/internal/__mocks__/mockDscStatus';
import { DataScienceStackComponent } from '@odh-dashboard/internal/concepts/areas/types';
import type { ConfigMapKind } from '@odh-dashboard/internal/k8sTypes';
import { projectDetails } from '../../../../pages/projects';
import { featureStoreIntegration } from '../../../../pages/featureStoreIntegration';
