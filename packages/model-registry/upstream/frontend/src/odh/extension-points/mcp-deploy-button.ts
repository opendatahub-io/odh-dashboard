 ...
 */
export type McpDeployButtonExtension = Extension<
  'mcp-catalog.mcp-server/deploy-button',
  {
    component: ComponentCodeRef;
  }
>;

export const isMcpDeployButtonExtension = (
  extension: Extension,
): extension is McpDeployButtonExtension =>
  extension.type === 'mcp-catalog.mcp-server/deploy-button';
