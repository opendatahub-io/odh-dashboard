...
function filtersFromParams(params: URLSearchParams): AgentsCatalogFiltersState {
  const filters: AgentsCatalogFiltersState = {};
...
function filtersToParams(filters: AgentsCatalogFiltersState, params: URLSearchParams): void {
  for (const key of AGENT_FILTER_KEYS) {
...
export function useAgentsUrlSync(): UseAgentsUrlSyncReturn {
