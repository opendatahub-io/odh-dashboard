...
import (
	...
	kubernetes2 "github.com/opendatahub-io/eval-hub/bff/internal/integrations/kubernetes"
...
func setupMock(mockK8sClient kubernetes.Interface, ctx context.Context) error {
	...
	err = createService(mockK8sClient, ctx, "eval-hub", "kubeflow", "Eval Hub", "Eval Hub Description", "10.0.0.10", "eval-hub")
	if err != nil {
		return err
	}
	err = createService(mockK8sClient, ctx, "eval-hub-one", "kubeflow", "Eval Hub One", "Eval Hub One description", "10.0.0.11", "eval-hub")
	if err != nil {
		return err
	}
	err = createService(mockK8sClient, ctx, "eval-hub-dora", "dora-namespace", "Eval Hub Dora", "Eval Hub Dora description", "10.0.0.12", "eval-hub")
	if err != nil {
		return err
	}
	err = createService(mockK8sClient, ctx, "eval-hub-bella", "bella-namespace", "Eval Hub Bella", "Eval Hub Bella description", "10.0.0.13", "eval-hub")
	if err != nil {
		return err
	}
	err = createService(mockK8sClient, ctx, "non-eval-hub", "kubeflow", "Not an Eval Hub", "Not an Eval Hub Bella description", "10.0.0.14", "")
	if err != nil {
		return err
	}
	...
	err = createGroupAccessRBAC(mockK8sClient, ctx, DefaultTestUsers[1].Groups[1], "dora-namespace", "eval-hub-dora")
	if err != nil {
