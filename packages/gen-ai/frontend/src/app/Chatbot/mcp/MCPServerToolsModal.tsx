...
const MCPServerToolsModal: React.FC<MCPServerToolsModalProps> = ({
  ...
  // Load saved tool selections or default to all tools
  const initialSelectedTools = React.useMemo(() => {
    ...
    // Map saved tool names back to tool objects
  ...
  // Track if we've initialized selections for this modal open
  const hasInitialized = React.useRef(false);

  // Update selections when modal opens and reset on close
  React.useEffect(() => {
