...
const MCPServerSuccessModal: React.FC<MCPServerSuccessModalProps> = ({
  ...
  const displaySelectedCount = totalToolsCount > 0 ? selectedToolsCount : 0;
  const displayTotalCount = totalToolsCount;
      ...
      <ModalBody>
        ...
        <div className="pf-v6-u-display-flex pf-v6-u-align-items-center pf-v6-u-mb-sm">
          <p className="pf-v6-u-mb-0 pf-v6-u-mr-md">
            {displaySelectedCount} out of {displayTotalCount} tools are active.
          </p>
          <Button
            variant="link"
            icon={<PencilAltIcon />}
