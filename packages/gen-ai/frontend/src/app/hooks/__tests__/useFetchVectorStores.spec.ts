...
import { listVectorStores } from '~/app/services/llamaStackService';
...
describe('useFetchVectorStores', () => {
  ...
  it('should fetch vector stores successfully when namespace is provided', async () => {
    ...
    mockGetVectorStores.mockReturnValue(jest.fn().mockResolvedValue(mockVectorStores));
  ...
  it('should handle service error when fetching vector stores', async () => {
    ...
    mockGetVectorStores.mockReturnValue(jest.fn().mockRejectedValue(serviceError));
  ...
  it('should handle loading state during fetch operation', async () => {
    ...
    mockGetVectorStores.mockReturnValue(
  ...
  it('should handle single vector store response', async () => {
    ...
    mockGetVectorStores.mockReturnValue(jest.fn().mockResolvedValue(singleVectorStoreArray));
  ...
  it('should handle empty vector stores response', async () => {
    ...
    mockGetVectorStores.mockReturnValue(jest.fn().mockResolvedValue(emptyResponse));
  ...
  it('should handle network timeout error', async () => {
    ...
    mockGetVectorStores.mockReturnValue(jest.fn().mockRejectedValue(timeoutError));
