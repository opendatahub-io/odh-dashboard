...
const useGenAiAPIState = (
  ...
  const createAPI = React.useCallback(
    (path: string) => ({
      ...
      getAAModelsWithHeaders: getAAModelsWithHeaders(path, queryParameters),
      ...
      getNemoGuardrailsStatus: getNemoGuardrailsStatus(path, queryParameters),
      initNemoGuardrails: initNemoGuardrails(path, queryParameters),
