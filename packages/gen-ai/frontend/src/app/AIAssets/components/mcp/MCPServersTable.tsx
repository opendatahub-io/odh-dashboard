...
import ChatbotEmptyState from '~/app/Chatbot/EmptyState';
...
const MCPServersTable: React.FC<MCPServersTableProps> = ({
  ...
  // Use useCheckboxTable for proper table selection UI (including select all checkbox)
  ...
  const { selections, tableProps, isSelected, toggleSelection } = useCheckboxTable(
    ...
    false, // persistSelections
  );

  // Log selection changes for debugging
  React.useEffect(() => {
    // console.log('MCPServersTable - Selected servers changed:', selections);
  }, [selections]);
