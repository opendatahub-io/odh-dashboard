...
func main() {
	...
	flag.StringVar(&cfg.PgvectorImage, "pgvector-image", getEnvAsString(pgvector.RelatedImageEnvVar, pgvector.DefaultImage), "Container image for auto-provisioned pgvector (set via RELATED_IMAGE_PGVECTOR)")
