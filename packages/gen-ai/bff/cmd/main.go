...
func main() {
	...
	flag.StringVar(&cfg.OGXCoreImage, "ogx-core-image", getEnvAsString("RELATED_IMAGE_OGX_CORE", ""), "OGX core container image for Sandbox CR creation (set via RELATED_IMAGE_OGX_CORE)")
