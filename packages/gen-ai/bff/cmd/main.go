...
func main() {
	...
	// MLflow BFF inter-communication configuration
	...
	flag.BoolVar(&cfg.BFFMLflowTLSEnabled, "bff-mlflow-tls-enabled", getEnvAsBool("BFF_MLFLOW_TLS_ENABLED", false), "Enable TLS for MLflow BFF communication")
	flag.StringVar(&cfg.BFFMLflowDevURL, "bff-mlflow-dev-url", getEnvAsString("BFF_MLFLOW_DEV_URL", ""), "Developer override URL for MLflow BFF (e.g., http://localhost:4010/api/v1)")
