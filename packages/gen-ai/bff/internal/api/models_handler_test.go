...
func TestInferenceServiceStatusExtraction(t *testing.T) {
	...
	t.Run("should return Error status when Ready condition is False", func(t *testing.T) {
	...
	t.Run("should return Error status when no Ready condition exists", func(t *testing.T) {
	...
	t.Run("should return Error status when no conditions exist", func(t *testing.T) {
