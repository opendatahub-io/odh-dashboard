...
import PromptProjectSelector from './PromptProjectSelector';
...
const MlflowPromptManagementPage: React.FC = () => {
  ...
  const globalNamespace = dashboardConfig.spec.globalMLflowNamespaces?.[0];
          ...
          <Flex alignItems={{ default: 'alignItemsCenter' }} gap={{ default: 'gapLg' }}>
            ...
            <FlexItem>
              <Flex alignItems={{ default: 'alignItemsCenter' }} gap={{ default: 'gapSm' }}>
                ...
                <FlexItem>
                  <PromptProjectSelector globalNamespace={globalNamespace} />
                </FlexItem>
              </Flex>
            </FlexItem>
            {isGlobalProject && (
