...
The Data Connect Hub UI is a standalone web app for Data Connect Hub. In this repository, you will find the frontend and backend for the Data Connect Hub UI.

## Contributing

You can check the [contributing guidelines] for more information on how to contribute to the Data Connect Hub UI.
...
You can find the OpenAPI specification for the Data Connect Hub UI in the [openapi](./api/openapi) directory.

## Targeted environments

There are two main deployment modes that the Data Connect Hub UI supports:
...
The following environment variables are used to configure the deployment and development environment for the Data Connect Hub UI. These variables should be defined in a `.env.local` file in the `clients/ui` directory of the project. **This values will affect the build and push commands**.
...
- **Default Value**: `ghcr.io/your-org/data-connect-hub/ui:latest`
- **Example**: `IMG_UI=ghcr.io/your-org/data-connect-hub/ui:latest`

### `IMG_UI_STANDALONE`

- **Description**: Specifies the image name and tag for the UI (with BFF) in **standalone mode**, used for local kind deployment.
- **Default Value**: `ghcr.io/your-org/data-connect-hub/ui-standalone:latest`
- **Example**: `IMG_UI_STANDALONE=ghcr.io/your-org/data-connect-hub/ui-standalone:latest`
...
- **Default Value**: `ghcr.io/your-org/data-connect-hub/ui-federated:latest`
- **Example**: `IMG_UI_FEDERATED=ghcr.io/your-org/data-connect-hub/ui-federated:latest`
...
IMG_UI=quay.io/<personal-registry>/data-connect-hub-ui:latest
IMG_UI_STANDALONE=quay.io/<personal-registry>/data-connect-hub-ui-standalone:latest
...
For more information on how to deploy the Data Connect Hub UI, please refer to the [Mod arch UI] documentation.
