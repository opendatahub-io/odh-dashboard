...
import ManageResourceAllocationSection from './ManageResourceAllocationSection.tsx';
...
import { DEFAULT_HARDWARE_PROFILE_FORM_DATA, ManageHardwareProfileSectionTitles } from '../const';
