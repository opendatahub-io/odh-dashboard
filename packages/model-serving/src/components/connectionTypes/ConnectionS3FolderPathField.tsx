...
import { containsOnlySlashes, isS3PathValid } from '@odh-dashboard/ui-core/utilities/string';
import { trimInputOnBlur, trimInputOnPaste } from '@odh-dashboard/ui-core/utilities/trimInput';
...
const ConnectionS3FolderPathField: React.FC<ConnectionFolderPathFieldProps> = ({
  ...
  const debouncedValidateFolderPath = React.useMemo(
    () =>
