...
import { trimInputOnPaste } from '@odh-dashboard/internal/concepts/connectionTypes/utils';

type OCIConnectionFieldProps = {
  ociHost?: string;
  modelUri?: string;
...
const OCIConnectionField: React.FC<OCIConnectionFieldProps> = ({
  ociHost,
  modelUri,
  setModelUri,
  ...
  return (
    <>
      ...
      >
        ...
        <FormGroup fieldId="model-uri" label="Model URI" isRequired style={{ width: '50%' }}>
          <InputGroup>
...
export default OCIConnectionField;
