...
// This file contains API-level end-to-end ("workflow") tests for the AutoRAG BFF.
//
...
func TestS3FileUploadListDownloadRoundTrip(t *testing.T) {
	...
	key := fmt.Sprintf("e2e-roundtrip-upload-%d.pdf", time.Now().UnixNano())
	content := "%PDF-1.4 e2e roundtrip fixture content"
