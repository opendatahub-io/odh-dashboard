...
In the initial phase, the FileExplorer widget uses the common S3 BFF API primarily for listing connections and files in a bucket/connection.

## Tasks

**Alpha**:
- [ ] Implement basic rendering of the component within this AutoRAG module
