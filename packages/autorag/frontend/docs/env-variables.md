...
The following environment variables are used to configure the deployment and development environment for the AutoRAG UI. These variables should be defined in a `.env.local` file in the `packages/autorag/frontend` directory of the project. **These values will affect the build and push commands**.
