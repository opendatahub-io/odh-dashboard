  ...
  <Flex alignItems={{ default: 'alignItemsCenter' }}>
    <Breadcrumb>
      <BreadcrumbItem data-testid="experiment-breadcrumb-home">
        <Link to={homePath} className="automl-breadcrumb-link-with-icon" onClick={onHomeNavigate}>
          <Flex
    ...
    <Flex>
      ...
      <FlexItem data-testid="project-navigator-link-in-breadcrumb">
        <Content component={ContentVariants.small}>
          <Link to={`/projects/${namespace}`} className="automl-breadcrumb-link-with-icon">
            <Flex
              alignItems={{ default: 'alignItemsCenter' }}
              spaceItems={{ default: 'spaceItemsXs' }}
            >
