...
function NoPipelineServer({ namespace }: NoPipelineServerProps): React.JSX.Element {
  return (
    <EmptyDetailsView
      ...
      description="To use AutoML, go to the Pipelines page, then create a new pipeline server or edit an existing one using Manage pipeline server configuration. Under Advanced settings, check the Enable AutoML and AutoRAG pipelines option."
