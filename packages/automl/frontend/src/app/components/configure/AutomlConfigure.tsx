                                  ...
                                  <Radio
                                    ...
                                    description={
                                      preset === PRESET_FASTER
                                        ? `${isTimeseries ? '4 vCPU, 16 GiB' : '4 vCPU, 16 GiB'} | A good default for most datasets.`
                                        : `${isTimeseries ? '8 vCPU, 32 GiB' : '8 vCPU, 32 GiB'} | Prioritizes stronger accuracy, but requires longer training.`
                                    }
