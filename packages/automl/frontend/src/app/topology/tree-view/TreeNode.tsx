...
const StatusOnlyCompletedBadge: React.FC<{ size: number }> = React.memo(({ size }) => {
  ...
  return (
    <SpineDot
      size={size}
      className="automl-tree-node__status-badge automl-tree-node__status-badge--completed"
...
const StatusOnlyCompletedDot: React.FC<{ size: number }> = React.memo(({ size }) => {
  ...
  return (
    <SpineDot
      size={size}
      className="automl-tree-node__status-badge automl-tree-node__status-badge--completed-dot"
      ringColor={borderColorStatusSuccess.var}
      coreColor={colorStatusSuccess.var}
      showConnectors
      innerIcon={
...
const StatusOnlyFailedSectionDot: React.FC<{ size: number }> = React.memo(({ size }) => (
  <SpineDot
    size={size}
    className="automl-tree-node__status-badge automl-tree-node__status-badge--failed-section"
