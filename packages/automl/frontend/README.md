...
A modern web interface for generating and visualizing AutoML models. Built with React 18, TypeScript, and PatternFly components.

---

## Overview

The AutoML UI provides an intuitive interface for generating ML models through automated evaluation and optimization. This standalone application integrates seamlessly with Kubeflow pipelines within the Open Data Hub ecosystem.
...
```typescript
import logo from '~/app/assets/images/automl-logo.png';

<img src={logo} alt="AutoML logo" />
```
