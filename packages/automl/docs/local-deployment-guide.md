...
## Local kubernetes deployment of AutoML

To test the BFF locally without mocking the k8s calls the AutoML backend can be deployed locally using kind.
