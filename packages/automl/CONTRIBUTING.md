...
Welcome to the AutoML project! We appreciate your interest in contributing to the automated machine learning optimization system for ODH.

## Getting Started

> **📌 Important:** Before contributing to AutoML, please review the main [ODH Dashboard Contributing Guide](/CONTRIBUTING.md) for general contribution guidelines, code of conduct, and git workflow.

For detailed prerequisites, setup instructions, and configuration options, see the [AutoML README](README.md).
...
**Update the [OpenAPI Specification](api/openapi/automl.yaml) when:**
...
**AutoML Specific:**
- [AutoML README](README.md) - Getting started and quick reference
...
AutoML is licensed under the Apache License 2.0. See [LICENSE](/LICENSE) for full details.
