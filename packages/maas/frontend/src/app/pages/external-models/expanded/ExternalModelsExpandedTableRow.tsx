...
import {
  ...
  getExternalProviderFromProviderRef,
  findExternalProvider,
...
const ExternalModelsExpandedTableRow: React.FC<ExternalModelsExpandedTableRowProps> = ({
  ...
  const getProviderForRow = (row: ProviderRef): ExternalProvider => {
    const listedProvider = findExternalProvider(
      externalProviders,
      row.providerName,
    ...
    return getExternalProviderFromProviderRef(row, externalModel.namespace);
  };
    ...
    <ExpandableRowContent>
      <Table
        ...
        rowRenderer={(row: ProviderRef) => {
          const provider = getProviderForRow(row);
