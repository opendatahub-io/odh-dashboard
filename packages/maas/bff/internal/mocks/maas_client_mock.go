...
func (m *MockMaaSClient) IssueToken(ctx context.Context, request models.APIKeyRequest) (*models.APIKeyResponse, error) {
	...
	// Parse the Expiration duration and calculate expiration time
	duration, err := time.ParseDuration(expiration)
	if err != nil {
		// Fallback to default if Expiration is invalid
