...
func GetMockExternalProviderSummaries() []models.ExternalProviderSummary {
	return []models.ExternalProviderSummary{
		...
		},
		{
			...
			EndpointUrl:         "failed-provider.com",
			AuthMechanism:       models.AuthMechanismAPIKey,
			CredentialSecretRef: "failed-provider-credentials",
			Provider:            "openai",
			Phase:               "Failed",
		...
		},
		{
			...
			EndpointUrl:         "invalid-provider.com",
			AuthMechanism:       models.AuthMechanismAPIKey,
			CredentialSecretRef: "invalid-provider-credentials",
			Provider:            "openai",
			Phase:               "Invalid",
