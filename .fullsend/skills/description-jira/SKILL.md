...
1. PR title and body (Description, How Has This Been Tested?, Test Impact,
   optional Product ask / tracking).
...
Read Jira `summary` + `description` against the PR body's Description,
testing/impact context, and Product ask / tracking.

- **aligned** — same product ask; call out what matches.
- **mismatch-justified** — they differ, and the Description (or
