...
> **Reference only** — Tekton PipelineRun YAML files are generated by the DevOps automation (`/create-component-onboarding-jira` skill), not by the `/konflux-onboarding` skill. This file is kept as a reference for understanding the pipeline structure and naming conventions.
