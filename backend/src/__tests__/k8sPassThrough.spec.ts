...
import { PassThroughData, passThroughResource } from '../routes/api/k8s/pass-through';
...
jest.mock('../routes/api/k8s/pass-through', () => ({
  ...jest.requireActual('../routes/api/k8s/pass-through'),
