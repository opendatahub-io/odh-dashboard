...
| **Dependency Eval**               | `skills/dependency-eval/`              | Auditing a package's deps against actual imports, checking version alignment, and validating override consistency |
