...
| **RBAC Review**                  | `skills/rbac-review/`                  | Reviewing code for proper RBAC enforcement across user types (cluster admin, dashboard admin, regular user), catching missing permission gates and fail-open patterns |
