...
const CustomServingRuntimesRoutes = React.lazy(
  () => import('../pages/modelServing/customServingRuntimes/CustomServingRuntimesRoutes'),
);
      ...
      <Routes>
        ...
        {isAdmin && (
          <>
            ...
            <Route path="/servingRuntimes/*" element={<CustomServingRuntimesRoutes />} />
