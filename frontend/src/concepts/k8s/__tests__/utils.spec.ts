...
describe('translateDisplayNameForK8sAndReport', () => {
  ...
  it('should NOT generate name if provided nothing', () => {
    expect(translateDisplayNameForK8sAndReport('')).toEqual([
      '',
      { autoGenerated: false, safeK8sPrefix: false, maxLength: false, isStaticPrefix: false },
    ...
    expect(
      translateDisplayNameForK8sAndReport('', { safeK8sPrefix: 'wb-', isStaticPrefix: true }),
    ).toEqual([
      '',
      { autoGenerated: false, safeK8sPrefix: false, maxLength: false, isStaticPrefix: false },
    ] satisfies ReturnArrayType);
  ...
  it('should handle cases where it applied additional criteria', () => {
    expect(translateDisplayNameForK8sAndReport('1234', { safeK8sPrefix: 'wb-' })).toEqual([
      'wb-1234',
      { autoGenerated: false, safeK8sPrefix: true, maxLength: false, isStaticPrefix: false },
    ] satisfies ReturnArrayType);

    expect(translateDisplayNameForK8sAndReport('foobarbaz', { maxLength: 3 })).toEqual([
      'foo',
      { autoGenerated: false, safeK8sPrefix: false, maxLength: true, isStaticPrefix: false },
    ] satisfies ReturnArrayType);

    expect(
      translateDisplayNameForK8sAndReport('test', { safeK8sPrefix: 'wb-', isStaticPrefix: true }),
    ).toEqual([
      'wb-test',
      { autoGenerated: false, safeK8sPrefix: true, maxLength: false, isStaticPrefix: true },
    ] satisfies ReturnArrayType);
  });
  ...
  it('should handle cases where multiple additional criteria are applied', () => {
    expect(
      ...
      'f-1',
      { autoGenerated: false, safeK8sPrefix: true, maxLength: true, isStaticPrefix: false },
    ] satisfies ReturnArrayType);
  ...
  it('should handle generate name cleanly', () => {
    ...
    expect(translateDisplayNameForK8sAndReport('-')).toEqual([
      ...
      { autoGenerated: true, safeK8sPrefix: false, maxLength: false, isStaticPrefix: false },
    ] satisfies ReturnArrayType);
    ...
    expect(translateDisplayNameForK8sAndReport('*(&(*&(*', { maxLength: 3 })).toEqual([
      ...
      { autoGenerated: true, safeK8sPrefix: false, maxLength: true, isStaticPrefix: false },
    ] satisfies ReturnArrayType);
    ...
    expect(
      ...
      `foo`, // known exception to providing a too long safeK8sPrefix
      { autoGenerated: true, safeK8sPrefix: true, maxLength: true, isStaticPrefix: false },
    ] satisfies ReturnArrayType);
  });
});
