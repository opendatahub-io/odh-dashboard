  ...
  describe('Active runs', () => {
    ...
    describe('with data', () => {
      ...
      describe('Table filter', () => {
        ...
        it('Sort by Name', () => {
          pipelineRunFilterBar.findSortButtonForActive('Name').click();
          pipelineRunFilterBar.findSortButtonForActive('Name').should(be.sortAscending);
          pipelineRunFilterBar.findSortButtonForActive('Name').click();
          pipelineRunFilterBar.findSortButtonForActive('Name').should(be.sortDescending);
        });
      });
    });
  });
    ...
    describe('with data', () => {
      ...
      describe('Table filter', () => {
        it('filter by run name', () => {
          ...
          archivedRunsTable.findRowByName('Test active run 1');
        });
        ...
        it('filter by experiment', () => {
          ...
          // Verify only rows with selected experiment exist
          archivedRunsTable.findRows().should('have.length', 2);
          archivedRunsTable.findRowByName('Test archived run 1');
          archivedRunsTable.findRowByName('Test archived run 2');
        });
        ...
        it('Sort by Name', () => {
          pipelineRunFilterBar.findSortButtonForArchive('Name').click();
          pipelineRunFilterBar.findSortButtonForArchive('Name').should(be.sortAscending);
          pipelineRunFilterBar.findSortButtonForArchive('Name').click();
          pipelineRunFilterBar.findSortButtonForArchive('Name').should(be.sortDescending);
        });
      });
    });
  });
  ...
  describe('Schedules', () => {
    ...
    describe('with data', () => {
      ...
      describe('Table filter', () => {
        ...
        it('Sort by Name', () => {
          pipelineRunFilterBar.findSortButtonforSchedules('Name').click();
          pipelineRunFilterBar.findSortButtonforSchedules('Name').should(be.sortAscending);
          pipelineRunFilterBar.findSortButtonforSchedules('Name').click();
          pipelineRunFilterBar.findSortButtonforSchedules('Name').should(be.sortDescending);
        });
      });
    });
  });
