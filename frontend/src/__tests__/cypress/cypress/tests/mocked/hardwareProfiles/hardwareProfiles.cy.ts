...
describe('Hardware Profile', () => {
  ...
  describe('hardware profile errors', () => {
    ...
    it('shows errors for some edge cases.', () => {
      const mockedHardwareProfiles = [
        mockHardwareProfile({
          name: 'Test Hardware Profile - 1',
          displayName: 'Test Hardware Profile - 1',
    ...
    it('shows errors for all edge cases.', () => {
      const mockedHardwareProfiles = [
        mockHardwareProfile({
          name: 'Test Hardware Profile - 1',
          displayName: 'Test Hardware Profile - 1',
        ...
        mockHardwareProfile({
          name: 'Test Hardware Profile - 4',
          displayName: 'Test Hardware Profile - 4',
          description: 'hardware profile 2',
          identifiers: [
            {
              displayName: 'Memory',
        ...
        mockHardwareProfile({
          name: 'Test Hardware Profile - 5',
          displayName: 'Test Hardware Profile - 5',
          description: 'hardware profile 2',
          labels: {
            'opendatahub.io/ootb': 'true',
          },
        ...
        mockHardwareProfile({
          name: 'Test Hardware Profile - 6',
          displayName: 'Test Hardware Profile - 6',
          description: 'hardware profile 2',
          labels: {
            'opendatahub.io/ootb': 'true',
          },
        ...
        mockHardwareProfile({
          name: 'Test Hardware Profile - 7',
          displayName: 'Test Hardware Profile - 7',
          description: 'hardware profile 2',
          labels: {
            'opendatahub.io/ootb': 'true',
          },
      ...
      row3.findEnabled().should('not.be.checked');
      const row4 = hardwareProfile.getRow('Test Hardware Profile - 4');
      row4.findEnabled().should('not.be.checked');
      const row5 = hardwareProfile.getRow('Test Hardware Profile - 5');
      row5.findEnabled().should('be.checked');
      const row6 = hardwareProfile.getRow('Test Hardware Profile - 6');
      row6.findEnabled().should('be.checked');
      const row7 = hardwareProfile.getRow('Test Hardware Profile - 7');
      row7.findEnabled().should('not.be.checked');
    });
  });
