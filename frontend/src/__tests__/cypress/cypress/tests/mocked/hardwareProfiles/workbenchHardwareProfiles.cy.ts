...
describe('Workbench Hardware Profiles', () => {
  ...
  describe('Hardware profiles column state labels in the workbenches table', () => {
    it('should show "Deleted" label when hardware profile is deleted', () => {
      ...
      // Verify "Deleted" label has correct styling
      workbenchPage
        .getNotebookRow('Test Notebook')
    ...
    it('should show "Disabled" label when hardware profile is disabled', () => {
      ...
      // Verify "Disabled" label has correct styling
      workbenchPage
        .getNotebookRow('Test Notebook')
        .findHardwareProfileDisabledLabel()
        .should('have.class', 'pf-m-yellow');
    ...
    it('should show "Updated" label when hardware profile spec has changed', () => {
            ...
            opts: {
              metadata: {
                annotations: {
                  ...
                  'opendatahub.io/hardware-profile-spec-snapshot': JSON.stringify({
                    identifiers: [
                      {
                        displayName: 'CPU',
                        identifier: 'cpu',
      ...
      // Verify "Updated" label has correct styling
      workbenchPage
        .getNotebookRow('Test Notebook')
