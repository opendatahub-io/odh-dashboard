...
describe.skip('Model details page', () => {
  it('Model details page', () => {
    ...
    cy.reload();
    verifyRelativeURL('/model-catalog/Red%20Hat/rhelai1/granite-8b-code-instruct/1%252E3%252E0');
    modelDetailsPage
  ...
  it('Should redirect to register catalog model page, when register model button is enabled', () => {
    ...
    verifyRelativeURL(
      '/model-catalog/Red%20Hat/rhelai1/granite-8b-code-instruct/1%252E3%252E0/register',
    );
  });
});
