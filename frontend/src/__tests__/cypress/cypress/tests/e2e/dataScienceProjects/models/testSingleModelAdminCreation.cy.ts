...
describe('[Product Bug: RHOAIENG-29747] Verify Admin Single Model Creation and Validation using the UI', () => {
  retryableBefore(() => {
  ...
  it(
    ...
    {
      tags: ['@Smoke', '@SmokeSet3', '@ODS-2626', '@Dashboard', '@Modelserving', '@NonConcurrent', '@Bug'],
    },
    () => {
