...
test('Empty project', async ({ page }) => {
  await page.goto(
    'http://localhost:6006/iframe.html?args=&id=tests-stories-pages-projects-projectdetails--empty-details-page&viewMode=story',
  );
...
test('Non-empty project', async ({ page }) => {
  await page.goto(
    'http://localhost:6006/iframe.html?id=tests-stories-pages-projects-projectdetails--default&viewMode=story',
  );
