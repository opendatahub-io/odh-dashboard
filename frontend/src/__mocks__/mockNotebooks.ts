// api/k8s/apis/kubeflow.org/v1/namespaces/project/notebooks
    ...
    "items": [
        {
            ...
            "metadata": {
                "annotations": {
                    ...
                    "notebooks.opendatahub.io/oauth-logout-url": "http://localhost:4010/projects/project?notebookLogout=workbench",
                ...
                "managedFields": [
                    {
                        ...
                        "fieldsV1": {
                            "f:metadata": {
                                "f:annotations": {
                                    "f:notebooks.kubeflow.org/last-activity": {}
                                }
                            }
                        },
                        "manager": "manager",
                        "operation": "Update",
                        "time": "2023-02-14T21:45:14Z"
                    },
                    {
                        "apiVersion": "kubeflow.org/v1",
                        "fieldsType": "FieldsV1",
