...
export const mockAPINamespaceProjectPods = {
  kind: 'PodList',
  apiVersion: 'v1',
  metadata: {
        ...
        containerStatuses: [
          ...
          },
          {
            ...
            image:
              'image-registry.openshift-image-registry.svc:5000/redhat-ods-applications/s2i-minimal-notebook:py3.8-v1',
            imageID:
              'image-registry.openshift-image-registry.svc:5000/redhat-ods-applications/s2i-minimal-notebook@sha256:a5a7738b09a204804e084a45f96360b568b0b9d85709c0ce6742d440ff917183',
