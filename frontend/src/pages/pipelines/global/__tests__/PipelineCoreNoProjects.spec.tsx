...
describe('PipelineCoreNoProjects', () => {
  ...
  it('should navigate to pipelines route when project is created', () => {
    useAccessReviewMock.mockReturnValue([true, true]);
    render(<PipelineCoreNoProjects />);

    fireEvent.click(screen.getByTestId('create-project'));
    expect(navigateMock).toHaveBeenCalledWith('/develop-train/pipelines/definitions/test-project');
  });
