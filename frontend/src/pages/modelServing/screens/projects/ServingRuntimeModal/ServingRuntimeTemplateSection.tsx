...
const ServingRuntimeTemplateSection: React.FC<ServingRuntimeTemplateSectionProps> = ({
        ...
        {filteredTemplates
          ...
          .map((template, index) => (
            <MenuItem
              ...
              isSelected={
                data.servingRuntimeTemplateName === getServingRuntimeNameFromTemplate(template) &&
                data.scope === SERVING_RUNTIME_SCOPE.Gloal
              }
              onClick={() => {
                if (
                  ...
                  setData('scope', SERVING_RUNTIME_SCOPE.Gloal);
  ...
  return (
    ...
    <FormGroup label="Serving runtime" fieldId="serving-runtime-template-selection" isRequired>
      {isProjectScoped && projectSpecificTemplates && !projectSpecificTemplates[1] ? (
        <Skeleton />
      ) : (
        <>
          {isProjectScoped &&
                  ...
                  <>
                    ...
                    {data.scope === SERVING_RUNTIME_SCOPE.Project && (
                      <Label
                        ...
                        icon={
                          <img
                            style={{ height: 15, paddingTop: '3px' }}
                            src={typedObjectImage(ProjectObjectType.project)}
                            alt=""
                          />
                        }
