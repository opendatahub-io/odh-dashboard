...
import { FeatureViewTab } from '#~/pages/featureStore/screens/featureViews/const';
import { FeatureView } from '#~/pages/featureStore/types/featureView.ts';
import FeatureViewDetailsView from '#~/pages/featureStore/screens/featureViews/featureViewDetails/FeatureViewDetailsTab';
import FeatureViewLineageTab from '#~/pages/featureStore/screens/featureViews/featureViewDetails/FeatureViewLineageTab';
import FeatureViewMaterialization from '#~/pages/featureStore/screens/featureViews/featureViewDetails/FeatureViewMaterialization';
import FeatureViewTransformation from '#~/pages/featureStore/screens/featureViews/featureViewDetails/FeatureViewTransformation';
import FeatureStoreInfoTooltip from '#~/pages/featureStore/screens/components/FeatureStoreInfoTooltip';
import FeatureViewConsumingTab from '#~/pages/featureStore/screens/featureViews/featureViewDetails/FeatureViewConsumingTab';
