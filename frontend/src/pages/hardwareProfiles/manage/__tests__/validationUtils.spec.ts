...
describe('hardwareProfileValidationSchema', () => {
  ...
  it('should validate a correct hardware profile', () => {
    const result = hardwareProfileValidationSchema.safeParse(validData);
  ...
  it('should fail when name is empty', () => {
    ...
    const result = hardwareProfileValidationSchema.safeParse(invalidData);
  ...
  it('should allow optional tolerations', () => {
    ...
    const result = hardwareProfileValidationSchema.safeParse(validDataWithoutTolerations);
    expect(result.success).toBe(true);
  });
