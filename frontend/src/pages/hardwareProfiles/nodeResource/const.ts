...
/** Radio label only; help popover and strategy summary use {@link NODE_SELECTORS_AND_TOLERATIONS_STRATEGY_LABEL}. */
export const NODE_SELECTORS_AND_TOLERATIONS_RADIO_LABEL = 'Node selectors and tolerations';
