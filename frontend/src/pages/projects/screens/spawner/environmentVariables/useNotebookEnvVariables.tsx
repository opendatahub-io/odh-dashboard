...
export const useNotebookEnvVariables = (
  ...
  const [fetchedVariable, envVariableloaded] = useFetchState(callback, []);

  React.useEffect(() => {
    setEnvVariables(fetchedVariable);
  }, [fetchedVariable]);

  return [envVariables, setEnvVariables, envVariableloaded];
};
