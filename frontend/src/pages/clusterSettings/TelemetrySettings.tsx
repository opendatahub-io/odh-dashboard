      ...
      footer={
        <Text component={TextVariants.small}>
          ...
          <Text
            ...
            href="https://docs.redhat.com/en/documentation/red_hat_openshift_ai_cloud_service/1/html/managing_resources/managing-collection-of-usage-data#usage-data-collection-notice-for-openshift-ai"
            target="_blank"
          >
            documentation
          </Text>
