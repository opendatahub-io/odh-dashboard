...
export enum StorageProvisioner {
  ...
  ODF_CEPHFS_CSI = 'openshift-storage.cephfs.csi.ceph.com',
  RBD_CSI = 'rbd.csi.ceph.com',
  ODF_RBD_CSI = 'openshift-storage.rbd.csi.ceph.com',
...
export const provisionerAccessModes: Record<StorageProvisioner, AccessMode[]> = {
  ...
  [StorageProvisioner.ODF_CEPHFS_CSI]: [
    AccessMode.RWO,
    AccessMode.RWX,
    AccessMode.ROX,
    AccessMode.RWOP,
  ...
  [StorageProvisioner.ODF_RBD_CSI]: [AccessMode.RWO, AccessMode.ROX, AccessMode.RWOP],
