...
import { Tr, TableProps, TbodyProps } from '@patternfly/react-table';
...
declare const TableBase: <T>({ data, columns, subColumns, hasNestedHeader, rowRenderer, enablePagination, toolbarContent, bottomToolbarContent, emptyTableView, caption, disableRowRenderSupport, selectAll, footerRow, tbodyProps, perPage, page, perPageOptions, onSetPage, onNextClick, onPreviousClick, onPerPageSelect, getColumnSort, itemCount, loading, toggleTemplate, disableItemCount, hasStickyColumns, ...props }: Props<T>) => React.ReactElement;
