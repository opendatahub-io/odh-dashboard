...
import type { AgentsCatalogFilterOptionsList, AgentsCatalogFiltersState } from '~/app/pages/agentsCatalog/types/agentsCatalogFilterOptions';
...
export type AgentsCatalogExtension = {
    ...
    setFilters: (filters: AgentsCatalogFiltersState | ((prev: AgentsCatalogFiltersState) => AgentsCatalogFiltersState)) => void;
    searchQuery: string;
...
export type AgentsCatalogContextType = CatalogContextValue<AgentsCatalogFilterOptionsList> & AgentsCatalogExtension;
