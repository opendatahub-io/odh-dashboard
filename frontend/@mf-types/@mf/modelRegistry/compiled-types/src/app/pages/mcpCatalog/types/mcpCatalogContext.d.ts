...
import type { McpCatalogFilterOptionsList, McpCatalogFiltersState } from '~/app/pages/mcpCatalog/types/mcpCatalogFilterOptions';
...
export type McpCatalogContextType = {
    ...
    setFilters: (filters: McpCatalogFiltersState | ((prev: McpCatalogFiltersState) => McpCatalogFiltersState)) => void;
    searchQuery: string;
