...
export declare const createModelVersion: (hostPath: string, queryParams?: Record<string, unknown>) => (opts: APIOptions, data: CreateModelVersionData) => Promise<ModelVersion>;
export declare const createModelVersionForRegisteredModel: (hostPath: string, queryParams?: Record<string, unknown>) => (opts: APIOptions, registeredModelId: string, data: CreateModelVersionData) => Promise<ModelVersion>;
export declare const createModelArtifact: (hostPath: string, queryParams?: Record<string, unknown>) => (opts: APIOptions, data: CreateModelArtifactData) => Promise<ModelArtifact>;
...
export declare const getModelArtifact: (hostPath: string, queryParams?: Record<string, unknown>) => (opts: APIOptions, modelArtifactId: string) => Promise<ModelArtifact>;
