 ...
 */
export declare const OdhDevFeatureFlagOverridesContext: React.Context<OdhDevFeatureFlagOverrides>;
/**
 * Hook to get dev feature flag overrides from ODH context.
 */
export declare const useOdhDevFeatureFlagOverrides: () => OdhDevFeatureFlagOverrides;
/**
 ...
 */
export type OdhDevFeatureFlagOverridesProviderExtension = Extension<'model-registry.feature-flag-overrides/provider', {
    /**
