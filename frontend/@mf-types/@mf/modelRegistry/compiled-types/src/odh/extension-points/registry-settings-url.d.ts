 ...
 */
export type RegistrySettingsUrlExtension = Extension<'model-registry.settings/url', {
    /**
...
export declare const isRegistrySettingsUrlExtension: ExtensionPredicate<RegistrySettingsUrlExtension>;
