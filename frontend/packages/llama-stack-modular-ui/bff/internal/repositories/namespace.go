...
func (r *NamespaceRepository) GetNamespaces(client kubernetes.KubernetesClientInterface, ctx context.Context, identity *kubernetes.RequestIdentity) ([]models.NamespaceModel, error) {
